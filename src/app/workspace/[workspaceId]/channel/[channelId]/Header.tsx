...
const Header = ({ title }: HeaderProps) => {
  ...
  const [   ConfirmDialog ,confirm]= useConfirm("Delete This Channel ? ", "Are you sure you want to delete this channel? This action cannot be undone.");
  const { mutate: Updatechannel, isPanding: isUpdatingchannel } = useUpdateChannels();
  const { mutate: Removechannel, isPanding: isRemovingchannel } = useDeleteChannel();
      ...
      <Dialog>
        ...
        <DialogContent className=" bg-gray-50 p-0 overflow-hidden ">
          ...
          <div className=" px-4 pb-4 flex flex-col gap-y-2 ">
            ...
            <button onClick={handleRemove} disabled={isRemovingchannel} className=" flex items-center gap-x-2 px-5 py-4 bg-white  rounded-lg hover:bg-gray-50 border cursor-pointer  text-rose-600">
